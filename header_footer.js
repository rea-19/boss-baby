...
// load a different styling for the header for the homepage 
function loadHeader() {
...
// load a different header when user is signed in
...
// sign in pop ups for pages exclusive for users with accounts
function initPopup() {
    const popup = document.getElementById('popupContainer');
    const loginForm = document.getElementById('loginForm');
    const signupForm = document.getElementById('signupForm');
...
// dynamic footer to reduce duplication
